...
- `reservations/`: Django app for the reservation domain, currently generated and registered but not yet implementing models, views, or URLs.
...
The `reservations` app is already created and registered in `config/settings.py`.
